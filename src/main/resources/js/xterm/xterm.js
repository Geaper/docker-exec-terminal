...
var Terminal = (function (_super) {
    ...
    Terminal.prototype.setOption = function (key, value) {
        ...
        switch (key) {
            ...
            case 'fontWeight':
            case 'fontWeightBold':
                var didCharSizeChange = (key === 'fontWeight' || key === 'fontWeightBold');
                this.renderer.clear();
...
var CharAtlasGenerator = (function () {
    ...
    CharAtlasGenerator.prototype.generate = function (scaledCharWidth, scaledCharHeight, fontSize, fontFamily, fontWeight, fontWeightBold, background, foreground, ansiColors) {
    ...
    CharAtlasGenerator.prototype._getFont = function (fontWeight, fontSize, fontFamily) {
