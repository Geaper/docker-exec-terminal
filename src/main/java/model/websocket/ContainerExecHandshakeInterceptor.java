...
public class ContainerExecHandshakeInterceptor extends HttpSessionHandshakeInterceptor {
    ...
    public boolean beforeHandshake(ServerHttpRequest request, ServerHttpResponse response, WebSocketHandler wsHandler,
        ...
        String command = ((ServletServerHttpRequest) request).getServletRequest().getParameter("command");
        String user = ((ServletServerHttpRequest) request).getServletRequest().getParameter("execUser");

        attributes.put("containerId",containerId);
        attributes.put("command", command);
        attributes.put("execUser", user);
